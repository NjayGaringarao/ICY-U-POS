...
Partial Class BackupFrm
    ...
    Private Sub InitializeComponent()
        ...
        ' TableLayoutPanel1
        ' 
        TableLayoutPanel1.BackColor = Color.FromArgb(CByte(254), CByte(250), CByte(224))
        ...
        ' GroupBox1
        ' 
        GroupBox1.BackColor = Color.FromArgb(CByte(169), CByte(179), CByte(136))
        ...
        ' Panel21
        ' 
        Panel21.BackColor = Color.FromArgb(CByte(95), CByte(111), CByte(82))
        ...
        Label3.TabIndex = 2
        Label3.Text = "The local data saved before " & vbCrLf & "importation is being delete" & vbCrLf & "and replaced by Imported" & vbCrLf & "Data. (Currently not available)"
        ' 
        ' Label2
        ' 
        ...
        ' ImportBtn
        ' 
        ImportBtn.BackColor = Color.FromArgb(CByte(185), CByte(148), CByte(112))
        ...
        ' GroupBox2
        ' 
        GroupBox2.BackColor = Color.FromArgb(CByte(169), CByte(179), CByte(136))
        ...
        ' Panel27
        ' 
        Panel27.BackColor = Color.FromArgb(CByte(95), CByte(111), CByte(82))
